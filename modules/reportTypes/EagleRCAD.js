...
export default class EagleRCAD extends EagleReport {
  ...
  id (pdfData) {
    ...
    if (this.isFirstPageOriginalPreliminary(pdfData)) {
      ...
      if (found) {
        console.log(`String ${this.ogPrelimIdString} found on the first page of RCAD!`);
        return true;
      } else {
        console.log(`String ${this.ogPrelimIdString} NOT found on the first page of RCAD!`);
        return false;
      }
    }
    ...
    if (found) {
      console.log(`String ${this.firstPageIdString} found on the first page of RCAD!`);
      return true;
    } else {
        console.log(`String ${this.firstPageIdString} NOT found on the first page of RCAD!`);
        return false;
    }
  }
}